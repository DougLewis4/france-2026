    ...
    if (isBooked) {
      ...
      return `<div class="housing-stop is-booked">
        ...
        <div class="housing-booked-summary">
          <div class="housing-booked-name-row">
            <div class="housing-booked-name">${esc(opt.name || display)}</div>
            ${opt.url ? `<a class="housing-view-btn" href="${esc(opt.url)}" target="_blank" rel="noopener">View listing ↗</a>` : ''}
          </div>
    ...
    return `<div class="itin-footer-col">
      ...
      ${opt
        ? `<div class="itin-stay-name">${esc(opt.name || display)}</div>
           ...
           <a class="itin-stay-link" href="${esc(opt.url)}" target="_blank" rel="noopener">View listing ↗</a>`
